...
public class HasilUpdate extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
          ...
          String query = "UPDATE camaba SET nama='"+nama+"',alamat1='"+alamat+"',prov='"+prov+"',kab='"+kab+"',kec='"+kec+"',jk='"+jk+"',tempat='"+tempat+"',tanggal='"+tl+"',agama='"+agama+"',asal='"+asal+"',jurusan='"+jurusan+"',telp='"+telp+"',email='"+email+"',ayah='"+ayah+"',pekerjaan1='"+pekerjaan1+"',pendidikan1='"+pendidikan1+"',pendapatan1='"+pendapatan1+"',ibu='"+ibu+"',pekerjaan2='"+pekerjaan2+"',pendidikan2='"+pendidikan2+"',pendapatan2='"+pendapatan2+"',wali='"+wali+"',pekerjaan3='"+pekerjaan3+"',pendidikan3='"+pendidikan3+"',pendapatan3='"+pendapatan3+"',alamat2='"+alamat2+"',jarak='"+jarak+"',trans='"+trans+"',foto='"+foto+"',pil1='"+pil1+"',pil2='"+pil2+"' WHERE nomor='"+nomor+"'";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HasilUpdate.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HasilUpdate().setVisible(true);
            }
        });
    }
