...
public class RegisterForm extends javax.swing.JFrame {
        String nama,alamat,prov,kab,kec,tempat,asal,jurusan,telp,email;
        public RegisterForm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        TempatField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                TempatFieldKeyTyped(evt);
            }
        });
        ...
        AsalField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                AsalFieldKeyTyped(evt);
            }
        });

        JurusanField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                JurusanFieldKeyTyped(evt);
            }
        });
        ...
        KabField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                KabFieldKeyTyped(evt);
            }
        });
        ...
        KecField.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                KecFieldKeyTyped(evt);
            }
        });
    ...
    private void AlamatFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AlamatFieldKeyTyped
        if((AlamatField.getText() + evt.getKeyChar()).length()>100){
                    evt.consume();
        }
    }//GEN-LAST:event_AlamatFieldKeyTyped
    ...
    private void KabFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KabFieldKeyTyped
        if((KabField.getText() + evt.getKeyChar()).length()>30){
                    evt.consume();
        }
    }//GEN-LAST:event_KabFieldKeyTyped

    private void KecFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_KecFieldKeyTyped
        if((KecField.getText() + evt.getKeyChar()).length()>30){
                    evt.consume();
        }
    }//GEN-LAST:event_KecFieldKeyTyped

    private void TempatFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TempatFieldKeyTyped
        if((TempatField.getText() + evt.getKeyChar()).length()>15){
                    evt.consume();
        }
    }//GEN-LAST:event_TempatFieldKeyTyped

    private void AsalFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_AsalFieldKeyTyped
        if((AsalField.getText() + evt.getKeyChar()).length()>30){
                    evt.consume();
        }
    }//GEN-LAST:event_AsalFieldKeyTyped

    private void JurusanFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JurusanFieldKeyTyped
        if((JurusanField.getText() + evt.getKeyChar()).length()>15){
                    evt.consume();
        }
    }//GEN-LAST:event_JurusanFieldKeyTyped

    private void NoFieldKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_NoFieldKeyTyped
        if((NoField.getText() + evt.getKeyChar()).length()>14){
                    evt.consume();
        }
    }//GEN-LAST:event_NoFieldKeyTyped
